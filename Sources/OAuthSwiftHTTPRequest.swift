...
open class OAuthSwiftHTTPRequest: NSObject, OAuthSwiftRequestHandle {
    ...
    convenience init(url: URL, method: Method = .GET, parameters: OAuthSwift.Parameters = [:], paramsLocation: ParamsLocation = .authorizationHeader, httpBody: Data? = nil, headers: OAuthSwift.Headers = [:], timeoutInterval: TimeInterval, sessionFactory: URLSessionFactory = .default) {
